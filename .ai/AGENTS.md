...
This directory contains shared AI context and documentation for the OpenShift Console Operator project.

## Files

- `context.md` - Primary AI context with project structure, conventions, and development guidelines
- `AGENTS.md` - This file, explaining the AI context structure
