...
func (c *FakeConsoleV1alpha1) ConsoleOperatorConfigs(namespace string) v1alpha1.ConsoleOperatorConfigInterface {
	return &FakeConsoleOperatorConfigs{c, namespace}
}
