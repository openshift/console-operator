...
// ConsoleV1alpha1Client is used to interact with features provided by the console.operator.openshift.io group.
type ConsoleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ConsoleV1alpha1Client) ConsoleOperatorConfigs(namespace string) ConsoleOperatorConfigInterface {
	return newConsoleOperatorConfigs(c, namespace)
}
