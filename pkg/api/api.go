...
const (
	...
	OpenShiftConsoleConfigMapKey                   = "console-config.yaml"
	...
	HubClusterConfigMapName                        = "hub-cluster-config"
	HubClusterConsoleURLKey                        = "consoleBasePath"
	...
	CreateHubClusterConfigManagedClusterActionName = "console-hub-cluster-config"
