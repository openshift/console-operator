...
func RunOperator(ctx *controllercmd.ControllerContext) error {
	...
	// we have 2 different named items under config.openshift.io, so should not pair this one down:
	// config.openshift.io Console cluster
	// config.openshift.io ClusterOperator console
	// additionally, we have
	// operator.openshift.io Console cluster
