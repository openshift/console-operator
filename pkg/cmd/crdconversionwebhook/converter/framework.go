...
var serializers = map[mediaType]runtime.Serializer{
	{"application", "json"}: serializerjson.NewSerializer(serializerjson.DefaultMetaFactory, scheme, scheme, false),
	{"application", "yaml"}: serializerjson.NewYAMLSerializer(serializerjson.DefaultMetaFactory, scheme, scheme),
}
