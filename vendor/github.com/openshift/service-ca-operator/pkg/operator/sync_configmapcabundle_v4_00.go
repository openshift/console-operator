...
func syncConfigMapCABundleController_v4_00_to_latest(c serviceCertSignerOperator, operatorConfig *scsv1.ServiceCA) error {
	...
	_, configMapModified, err := manageConfigMapCABundleConfigMap_v4_00_to_latest(c.corev1Client, operatorConfig)
	if err != nil {
	...
	_, _, err = manageConfigMapCABundleDeployment_v4_00_to_latest(c.appsv1Client, operatorConfig, forceDeployment)
	return err
}

func manageConfigMapCABundleConfigMap_v4_00_to_latest(client coreclientv1.ConfigMapsGetter, operatorConfig *scsv1.ServiceCA) (*corev1.ConfigMap, bool, error) {
...
func manageConfigMapCABundleDeployment_v4_00_to_latest(client appsclientv1.AppsV1Interface, options *scsv1.ServiceCA, forceDeployment bool) (*appsv1.Deployment, bool, error) {
