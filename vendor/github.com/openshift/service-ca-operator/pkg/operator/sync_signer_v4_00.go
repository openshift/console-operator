...
func syncSigningController_v4_00_to_latest(c serviceCertSignerOperator, operatorConfig *scsv1.ServiceCA) error {
	...
	_, configMapModified, err := manageSigningConfigMap_v4_00_to_latest(c.corev1Client, operatorConfig)
	if err != nil {
		return fmt.Errorf("%q: %v", "configmap", err)
	}

	_, signingSecretModified, err := manageSigningSecret_v4_00_to_latest(c.corev1Client)
	if err != nil {
	...
	_, _, err = manageSignerDeployment_v4_00_to_latest(c.appsv1Client, operatorConfig, forceDeployment)
	return err
}

func manageSigningConfigMap_v4_00_to_latest(client coreclientv1.ConfigMapsGetter, operatorConfig *scsv1.ServiceCA) (*corev1.ConfigMap, bool, error) {
...
func manageSigningSecret_v4_00_to_latest(client coreclientv1.SecretsGetter) (*corev1.Secret, bool, error) {
...
func manageSignerDeployment_v4_00_to_latest(client appsclientv1.AppsV1Interface, options *scsv1.ServiceCA, forceDeployment bool) (*appsv1.Deployment, bool, error) {
