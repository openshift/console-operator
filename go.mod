...
replace (
	github.com/openshift/api => github.com/jhadvig/api v0.0.0-20220909092727-aab1693447da
	github.com/openshift/client-go => github.com/jhadvig/client-go v0.0.0-20220909094556-07a1d60cb20c
)
